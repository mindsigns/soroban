defmodule Soroban.InvoiceControllerTest do
  use Soroban.ConnCase

  alias Soroban.Invoice
  @valid_attrs %{date: %{day: 17, month: 4, year: 2010}, end: %{day: 17, month: 4, year: 2010}, number: "some content", start: %{day: 17, month: 4, year: 2010}, total: "120.5"}
  @invalid_attrs %{}
